...
model_paths += utils.get_subdirs(f'{args.cache_dir}/quantized')
model_paths += utils.get_subdirs(f'{args.cache_dir}/layerwise_quantized')
model_paths += utils.get_subdirs(f'{args.cache_dir}/post_sqllm_quantized')
model_paths += utils.get_subdirs(f'{args.cache_dir}/rbvt_sqllm_quantized')  # legacy naming
