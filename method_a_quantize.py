...
def main():
    ...
    if args.stats_layer_chunk_size < 1:
        raise ValueError("--stats-layer-chunk-size must be positive")
    if args.sqllm_layer_chunk_size < 0:
        raise ValueError("--sqllm-layer-chunk-size must be non-negative")
