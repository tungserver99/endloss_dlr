...
POST_QUANTIZED_PATH="./cache/post_sqllm_quantized/${MODEL_BASENAME}-w${BITS}-sqllm-cgc-${DATASET}_s${NUM_EXAMPLES}_blk${SEQ_LEN}_lambda${RBVT_LAMBDA_TAG}"
MODEL_PATH="./cache/post_sqllm_packed/anyprec-sqllm-cgc-${MODEL_BASENAME}-w${BITS}-${DATASET}_s${NUM_EXAMPLES}_blk${SEQ_LEN}_lambda${RBVT_LAMBDA_TAG}"
